...
#elif defined(bl702_lego_train)
#include "bl702_lego_train/peripheral_config.h"
#include "bl702_lego_train/clock_config.h"
#include "bl702_lego_train/pinmux_config.h"
#else
